...
public final class CategoryData {
    ...
    public static ArrayList<Category> getFood(){
        ...
        int [] images = {R.drawable.food4,R.drawable.food1,R.drawable.food2,R.drawable.food3};
    ...
    public static ArrayList<Category> getTravel(){
        ArrayList<Category> data = new ArrayList<>();
        String [] names = {"Tiket Dunia Fantasi (Dufan) Ancol","Tidung Solata Homestay","Pulau Kanawa","Pulau Padar"};
